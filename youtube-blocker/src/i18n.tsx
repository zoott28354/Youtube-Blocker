...
export const translations = {
  it: {
    ...
    importListTitle: "Importa lista",
    importListHint: "Incolla domini o carica un file .txt/.csv. La lista viene solo salvata: il blocco si applica dopo con Blocca.",
    importTextPlaceholder: "un dominio per riga o separati da virgole",
    importFileBtn: "Carica file",
    importConfirmBtn: "Importa",
    importListNamePlaceholder: "Nome lista importata",
    importNoDomains: "Nessun dominio valido trovato",
    editList: "Modifica",
    deleteList: "Elimina",
  ...
  en: {
    ...
    importListHint: "Paste domains or load a .txt/.csv file. The list is only saved: protection is applied later with Block.",
    importTextPlaceholder: "one domain per line or comma-separated",
    importFileBtn: "Load file",
    importConfirmBtn: "Import",
    importListNamePlaceholder: "Imported list name",
    importNoDomains: "No valid domains found",
    editList: "Edit",
    deleteList: "Delete",
